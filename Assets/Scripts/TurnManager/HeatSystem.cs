...
public class HeatSystem : MonoBehaviour
{
    ...
    private int redHeat;
    [SerializeField]
    private int blueHeat;
    [SerializeField]
    private int decreaseAmount = 2;
    [SerializeField]
    private int maxHeat = 3;

    [SerializeField]
    private int minHeat = 0;

    [SerializeField]
    private UnityEvent onRedIncrement;
    [SerializeField]
    private UnityEvent onBlueIncrement;
    [SerializeField]
    private UnityEvent onRedReset;
    [SerializeField]
    private UnityEvent onBlueReset;

    [SerializeField]
    private UnityEvent onMaxHeat;
    [SerializeField]
    private UnityEvent onNoMaxHeat;
