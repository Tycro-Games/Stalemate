...
{
    [SerializeField]
    private TextMeshProUGUI redUnitCount;
    [SerializeField]
    private TextMeshProUGUI blueUnitCount;
    [SerializeField]
    private UnityEvent onWinRed;
    [SerializeField]
    private UnityEvent onWinBlue;
    [SerializeField]
    private UnityEvent onLose;
    [SerializeField]
    private UnityEvent onNotLose;
