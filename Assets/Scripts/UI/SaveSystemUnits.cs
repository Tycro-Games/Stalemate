...
public class SaveSystemUnits : MonoBehaviour {
  ...
  public void DeleteSavedData() {
    ...
    // Delete the red units file
    DeleteFile(persistentPath + filePathRed);

    // Delete the blue units file
    DeleteFile(persistentPath + filePathBlue);

    // Delete the winner status file
  ...
  private bool LoadOneSide(string fileToRead, ref UnitUIRenderer[] unitUI,
                           ref SerializableList<int> units) {
